      ...
      <div className="mx-auto max-w-6xl px-5 pb-24 pt-32 sm:px-8 sm:pb-32 sm:pt-40">
        <div className="grid items-center gap-14 lg:grid-cols-[1fr_0.95fr] lg:gap-16">
          <div className="rise">
            ...
            <h1 className="mt-5 max-w-xl text-4xl font-medium leading-[1.08] sm:text-5xl lg:text-[3.4rem]">
            ...
            <div className="mt-12 flex flex-wrap items-center gap-x-3 gap-y-2 border-t border-line-subtle pt-6">
